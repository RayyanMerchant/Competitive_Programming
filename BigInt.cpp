/*
Link : https://github.com/ngthanhtrung23/ACM_Notebook_new/blob/master/Math/bigint.h
Fixed BigInt operator/ function bug where it coudn't calculate a / b if a was zero so added a condition for when a == 0;
*/
